...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'email' => ['nullable', 'string'/*, 'email', 'sometimes'*/],
    ...
    public function authenticate(): void
    {
        ...
        // Intentar autenticación con el campo correspondiente
        if (!Auth::attempt([$loginField => $credentials['email'], 'password' => $password], $this->boolean('remember'))) {
