    ...
    <div class="container-fluid p-0">
        <div class="d-flex align-items-center border-bottom ps-4 p-2">
            ...
            <span class="text-black fw-bold fs-4">
                CREAR CLIENTE POTENCIAL</span>
            </span>
        </div>

        <form class="m-3" method="POST" action="{{ route('customer.store.lead') }}" enctype="multipart/form-data">
            @csrf
            <div class="border rounded shadow p-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" placeholder="0000000000" maxlength="25"
                            name="phone" autocomplete="off" min="0" required>
                    </div>

                    <div class="col-lg-4 col-12 mb-3">
                        <label for="zip_code" class="form-label is-required">{{ __('customer.data.zip_code') }} :</label>
                        <input type="number" min=10000 max=99999 class="form-control" name="zip_code" placeholder="00000"
                    ...
                    <div class="col-lg-3 col-12 mb-3" id="company-type">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Describe el motivo/razón por la cual llamaron..." id="reason"
                            rows="3" name="reason" data-maxlength="200"></textarea>
                    </div>
                    <div class="col-12 mb-3">
